...
/**
 * @generated from protobuf service ride.wallet.v1alpha1.WalletService
 */
export interface IWalletService extends grpc.UntypedServiceImplementation {
    /**
     * Account related methods
     *
     * @generated from protobuf rpc: CreateAccount(ride.wallet.v1alpha1.CreateAccountRequest) returns (ride.wallet.v1alpha1.CreateAccountResponse);
     */
    createAccount: grpc.handleUnaryCall<CreateAccountRequest, CreateAccountResponse>;
    /**
     * @generated from protobuf rpc: GetAccount(ride.wallet.v1alpha1.GetAccountRequest) returns (ride.wallet.v1alpha1.GetAccountResponse);
     */
    getAccount: grpc.handleUnaryCall<GetAccountRequest, GetAccountResponse>;
    /**
     * @generated from protobuf rpc: GetAccountByUid(ride.wallet.v1alpha1.GetAccountByUidRequest) returns (ride.wallet.v1alpha1.GetAccountByUidResponse);
     */
    getAccountByUid: grpc.handleUnaryCall<GetAccountByUidRequest, GetAccountByUidResponse>;
    /**
     * Transaction related methods
     *
     * @generated from protobuf rpc: CreateTransactions(ride.wallet.v1alpha1.CreateTransactionsRequest) returns (ride.wallet.v1alpha1.CreateTransactionsResponse);
     */
    createTransactions: grpc.handleUnaryCall<CreateTransactionsRequest, CreateTransactionsResponse>;
    /**
     * @generated from protobuf rpc: GetTransaction(ride.wallet.v1alpha1.GetTransactionRequest) returns (ride.wallet.v1alpha1.GetTransactionResponse);
     */
    getTransaction: grpc.handleUnaryCall<GetTransactionRequest, GetTransactionResponse>;
    /**
     * @generated from protobuf rpc: ListTransactionsByBatchId(ride.wallet.v1alpha1.ListTransactionsByBatchIdRequest) returns (ride.wallet.v1alpha1.ListTransactionsByBatchIdResponse);
     */
    listTransactionsByBatchId: grpc.handleUnaryCall<ListTransactionsByBatchIdRequest, ListTransactionsByBatchIdResponse>;
    /**
     * @generated from protobuf rpc: ListTransactionsByAccountId(ride.wallet.v1alpha1.ListTransactionsByAccountIdRequest) returns (ride.wallet.v1alpha1.ListTransactionsByAccountIdResponse);
     */
    listTransactionsByAccountId: grpc.handleUnaryCall<ListTransactionsByAccountIdRequest, ListTransactionsByAccountIdResponse>;
}
/**
 * @grpc/grpc-js definition for the protobuf service ride.wallet.v1alpha1.WalletService.
 *
...
export const walletServiceDefinition: grpc.ServiceDefinition<IWalletService> = {
    createAccount: {
        path: "/ride.wallet.v1alpha1.WalletService/CreateAccount",
    ...
    getAccount: {
        path: "/ride.wallet.v1alpha1.WalletService/GetAccount",
    ...
    getAccountByUid: {
        path: "/ride.wallet.v1alpha1.WalletService/GetAccountByUid",
    ...
    createTransactions: {
        path: "/ride.wallet.v1alpha1.WalletService/CreateTransactions",
    ...
    getTransaction: {
        path: "/ride.wallet.v1alpha1.WalletService/GetTransaction",
    ...
    listTransactionsByBatchId: {
        path: "/ride.wallet.v1alpha1.WalletService/ListTransactionsByBatchId",
    ...
    listTransactionsByAccountId: {
        path: "/ride.wallet.v1alpha1.WalletService/ListTransactionsByAccountId",
