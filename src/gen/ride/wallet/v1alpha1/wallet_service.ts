// @generated by protobuf-ts 2.2.4 with parameter server_grpc1,client_grpc1,generate_dependencies
// @generated from protobuf file "ride/wallet/v1alpha1/wallet_service.proto" (package "ride.wallet.v1alpha1", syntax proto3)
// tslint:disable
...
/**
 * @generated from protobuf message ride.wallet.v1alpha1.CreateAccountRequest
 */
...
/**
 * @generated from protobuf message ride.wallet.v1alpha1.CreateAccountResponse
 */
export interface CreateAccountResponse {
    /**
     * @generated from protobuf field: ride.wallet.v1alpha1.Account account = 1;
     */
    account?: Account;
}
/**
 * @generated from protobuf message ride.wallet.v1alpha1.GetAccountRequest
 */
...
/**
 * @generated from protobuf message ride.wallet.v1alpha1.GetAccountResponse
 */
...
/**
 * @generated from protobuf message ride.wallet.v1alpha1.GetAccountByUidRequest
 */
...
/**
 * @generated from protobuf message ride.wallet.v1alpha1.GetAccountByUidResponse
 */
...
/**
 * @generated from protobuf message ride.wallet.v1alpha1.Account
 */
...
/**
 * @generated from protobuf message ride.wallet.v1alpha1.CreateTransactionsRequest
 */
export interface CreateTransactionsRequest {
    /**
     * @generated from protobuf field: repeated ride.wallet.v1alpha1.CreateTransactionsRequest.Entry transactions = 2;
     */
    transactions: CreateTransactionsRequest_Entry[];
}
/**
 * @generated from protobuf message ride.wallet.v1alpha1.CreateTransactionsRequest.Entry
 */
export interface CreateTransactionsRequest_Entry {
    ...
    amount: number;
    /**
     * @generated from protobuf field: ride.wallet.v1alpha1.TransactionType type = 4;
     */
    type: TransactionType;
}
/**
 * @generated from protobuf message ride.wallet.v1alpha1.CreateTransactionsResponse
 */
...
/**
 * @generated from protobuf message ride.wallet.v1alpha1.GetTransactionRequest
 */
...
/**
 * @generated from protobuf message ride.wallet.v1alpha1.GetTransactionResponse
 */
export interface GetTransactionResponse {
    /**
     * @generated from protobuf field: ride.wallet.v1alpha1.Transaction transaction = 1;
     */
    transaction?: Transaction;
}
/**
 * @generated from protobuf message ride.wallet.v1alpha1.ListTransactionsByBatchIdRequest
 */
...
/**
 * @generated from protobuf message ride.wallet.v1alpha1.ListTransactionsByBatchIdResponse
 */
export interface ListTransactionsByBatchIdResponse {
    /**
     * @generated from protobuf field: repeated ride.wallet.v1alpha1.Transaction transactions = 1;
     */
    transactions: Transaction[];
}
/**
 * @generated from protobuf message ride.wallet.v1alpha1.ListTransactionsByAccountIdRequest
 */
...
/**
 * @generated from protobuf message ride.wallet.v1alpha1.ListTransactionsByAccountIdResponse
 */
...
/**
 * @generated from protobuf message ride.wallet.v1alpha1.Transaction
 */
...
/**
 * @generated from protobuf enum ride.wallet.v1alpha1.TransactionType
 */
...
class CreateAccountRequest$Type extends MessageType<CreateAccountRequest> {
    constructor() {
        super("ride.wallet.v1alpha1.CreateAccountRequest", [
...
/**
 * @generated MessageType for protobuf message ride.wallet.v1alpha1.CreateAccountRequest
 */
...
class CreateAccountResponse$Type extends MessageType<CreateAccountResponse> {
    constructor() {
        super("ride.wallet.v1alpha1.CreateAccountResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CreateAccountResponse): CreateAccountResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* ride.wallet.v1alpha1.Account account */ 1:
    ...
    internalBinaryWrite(message: CreateAccountResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* ride.wallet.v1alpha1.Account account = 1; */
        if (message.account)
...
/**
 * @generated MessageType for protobuf message ride.wallet.v1alpha1.CreateAccountResponse
 */
...
class GetAccountRequest$Type extends MessageType<GetAccountRequest> {
    constructor() {
        super("ride.wallet.v1alpha1.GetAccountRequest", [
...
/**
 * @generated MessageType for protobuf message ride.wallet.v1alpha1.GetAccountRequest
 */
...
class GetAccountResponse$Type extends MessageType<GetAccountResponse> {
    constructor() {
        super("ride.wallet.v1alpha1.GetAccountResponse", [
            { no: 1, name: "account", kind: "message", T: () => Account }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message ride.wallet.v1alpha1.GetAccountResponse
 */
...
class GetAccountByUidRequest$Type extends MessageType<GetAccountByUidRequest> {
    constructor() {
        super("ride.wallet.v1alpha1.GetAccountByUidRequest", [
            { no: 1, name: "uid", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 99, name: "field_mask", kind: "message", T: () => FieldMask }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message ride.wallet.v1alpha1.GetAccountByUidRequest
 */
...
class GetAccountByUidResponse$Type extends MessageType<GetAccountByUidResponse> {
    constructor() {
        super("ride.wallet.v1alpha1.GetAccountByUidResponse", [
            { no: 1, name: "account", kind: "message", T: () => Account }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message ride.wallet.v1alpha1.GetAccountByUidResponse
 */
export const GetAccountByUidResponse = new GetAccountByUidResponse$Type();
// @generated message type with reflection information, may provide speed optimized methods
class Account$Type extends MessageType<Account> {
    constructor() {
        super("ride.wallet.v1alpha1.Account", [
            { no: 1, name: "account_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
...
/**
 * @generated MessageType for protobuf message ride.wallet.v1alpha1.Account
 */
export const Account = new Account$Type();
// @generated message type with reflection information, may provide speed optimized methods
class CreateTransactionsRequest$Type extends MessageType<CreateTransactionsRequest> {
    constructor() {
        super("ride.wallet.v1alpha1.CreateTransactionsRequest", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: CreateTransactionsRequest): CreateTransactionsRequest {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated ride.wallet.v1alpha1.CreateTransactionsRequest.Entry transactions */ 2:
    ...
    internalBinaryWrite(message: CreateTransactionsRequest, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated ride.wallet.v1alpha1.CreateTransactionsRequest.Entry transactions = 2; */
...
/**
 * @generated MessageType for protobuf message ride.wallet.v1alpha1.CreateTransactionsRequest
 */
...
class CreateTransactionsRequest_Entry$Type extends MessageType<CreateTransactionsRequest_Entry> {
    constructor() {
        super("ride.wallet.v1alpha1.CreateTransactionsRequest.Entry", [
            { no: 2, name: "account_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "amount", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 4, name: "type", kind: "enum", T: () => ["ride.wallet.v1alpha1.TransactionType", TransactionType, "TRANSACTION_TYPE_"] }
        ]);
    }
        ...
        while (reader.pos < end) {
            ...
            switch (fieldNo) {
                ...
                case /* int32 amount */ 3:
                    ...
                    break;
                case /* ride.wallet.v1alpha1.TransactionType type */ 4:
    ...
    internalBinaryWrite(message: CreateTransactionsRequest_Entry, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        ...
        /* ride.wallet.v1alpha1.TransactionType type = 4; */
        if (message.type !== 0)
...
/**
 * @generated MessageType for protobuf message ride.wallet.v1alpha1.CreateTransactionsRequest.Entry
 */
...
class CreateTransactionsResponse$Type extends MessageType<CreateTransactionsResponse> {
    constructor() {
        super("ride.wallet.v1alpha1.CreateTransactionsResponse", [
...
/**
 * @generated MessageType for protobuf message ride.wallet.v1alpha1.CreateTransactionsResponse
 */
...
class GetTransactionRequest$Type extends MessageType<GetTransactionRequest> {
    constructor() {
        super("ride.wallet.v1alpha1.GetTransactionRequest", [
...
/**
 * @generated MessageType for protobuf message ride.wallet.v1alpha1.GetTransactionRequest
 */
...
class GetTransactionResponse$Type extends MessageType<GetTransactionResponse> {
    constructor() {
        super("ride.wallet.v1alpha1.GetTransactionResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: GetTransactionResponse): GetTransactionResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* ride.wallet.v1alpha1.Transaction transaction */ 1:
    ...
    internalBinaryWrite(message: GetTransactionResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* ride.wallet.v1alpha1.Transaction transaction = 1; */
...
/**
 * @generated MessageType for protobuf message ride.wallet.v1alpha1.GetTransactionResponse
 */
...
class ListTransactionsByBatchIdRequest$Type extends MessageType<ListTransactionsByBatchIdRequest> {
    constructor() {
        super("ride.wallet.v1alpha1.ListTransactionsByBatchIdRequest", [
            { no: 1, name: "batch_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 99, name: "field_mask", kind: "message", T: () => FieldMask }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message ride.wallet.v1alpha1.ListTransactionsByBatchIdRequest
 */
...
class ListTransactionsByBatchIdResponse$Type extends MessageType<ListTransactionsByBatchIdResponse> {
    constructor() {
        super("ride.wallet.v1alpha1.ListTransactionsByBatchIdResponse", [
    ...
    internalBinaryRead(reader: IBinaryReader, length: number, options: BinaryReadOptions, target?: ListTransactionsByBatchIdResponse): ListTransactionsByBatchIdResponse {
        ...
        while (reader.pos < end) {
            let [fieldNo, wireType] = reader.tag();
            switch (fieldNo) {
                case /* repeated ride.wallet.v1alpha1.Transaction transactions */ 1:
    ...
    internalBinaryWrite(message: ListTransactionsByBatchIdResponse, writer: IBinaryWriter, options: BinaryWriteOptions): IBinaryWriter {
        /* repeated ride.wallet.v1alpha1.Transaction transactions = 1; */
        for (let i = 0; i < message.transactions.length; i++)
...
/**
 * @generated MessageType for protobuf message ride.wallet.v1alpha1.ListTransactionsByBatchIdResponse
 */
...
class ListTransactionsByAccountIdRequest$Type extends MessageType<ListTransactionsByAccountIdRequest> {
    constructor() {
        super("ride.wallet.v1alpha1.ListTransactionsByAccountIdRequest", [
            { no: 1, name: "account_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 99, name: "field_mask", kind: "message", T: () => FieldMask }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message ride.wallet.v1alpha1.ListTransactionsByAccountIdRequest
 */
...
class ListTransactionsByAccountIdResponse$Type extends MessageType<ListTransactionsByAccountIdResponse> {
    constructor() {
        super("ride.wallet.v1alpha1.ListTransactionsByAccountIdResponse", [
            { no: 1, name: "transactions", kind: "message", repeat: 1 /*RepeatType.PACKED*/, T: () => Transaction }
        ]);
    }
...
/**
 * @generated MessageType for protobuf message ride.wallet.v1alpha1.ListTransactionsByAccountIdResponse
 */
...
class Transaction$Type extends MessageType<Transaction> {
    constructor() {
        super("ride.wallet.v1alpha1.Transaction", [
            { no: 1, name: "transaction_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 2, name: "account_id", kind: "scalar", T: 9 /*ScalarType.STRING*/ },
            { no: 3, name: "amount", kind: "scalar", T: 5 /*ScalarType.INT32*/ },
            { no: 4, name: "type", kind: "enum", T: () => ["ride.wallet.v1alpha1.TransactionType", TransactionType, "TRANSACTION_TYPE_"] },
...
/**
 * @generated MessageType for protobuf message ride.wallet.v1alpha1.Transaction
 */
export const Transaction = new Transaction$Type();
/**
 * @generated ServiceType for protobuf service ride.wallet.v1alpha1.WalletService
 */
export const WalletService = new ServiceType("ride.wallet.v1alpha1.WalletService", [
