...
// Source: github.com/ride-app/wallet-service/internal/repositories/recharge (interfaces: RechargeRepository)
...
func (m *MockRechargeRepository) CreateRecharge(arg0 context.Context, arg1 logger.Logger, arg2 *walletv1alpha1.Recharge, arg3 *map[string]interface{}) (*time.Time, error) {
	m.ctrl.T.Helper()
