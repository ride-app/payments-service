...
// Source: github.com/ride-app/payments-service/internal/repositories/wallet (interfaces: WalletRepository)
...
func (m *MockWalletRepository) GetTransaction(arg0 context.Context, arg1 logger.Logger, arg2, arg3 string) (*paymentsv1alpha1.Transaction, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetTransaction", arg0, arg1, arg2, arg3)
	ret0, _ := ret[0].(*paymentsv1alpha1.Transaction)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockWalletRepository) GetTransactions(arg0 context.Context, arg1 logger.Logger, arg2 string, arg3 *string) ([]*paymentsv1alpha1.Transaction, error) {
	m.ctrl.T.Helper()
...
func (m *MockWalletRepository) GetWallet(arg0 context.Context, arg1 logger.Logger, arg2 string) (*paymentsv1alpha1.Wallet, error) {
	m.ctrl.T.Helper()
